...
const AddMilestoneForm = ({
  ...
  return (
    show && (
      ...
      >
        <div
          className="bg-white rounded-lg shadow-xl w-full max-w-[570px] mx-4 py-3 px-5"
        ...
        >
          ...
          <div className="p-6">
            <h2 className="text-2xl font-normal mb-4">Propose Milestone</h2>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div>
                  <div className="flex items-center">
                    ...
                    <span className="font-medium ml-1 text-sm">(Min $5)</span>
                  </div>
                  <p className="text-sm m-0 font-light">
                    How much would you like to be paid to complete this part of
                    the project?
                  </p>
                </div>
                <input
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-light">
                  Describe the work you'll deliver in this milestone. What will
                  be done when you're finished? What content will you deliver?
                  Is this a draft, a segment, a complete project?
                </p>
                <TextEditor
                  value={formState.description}
                  onChange={onDescriptionChange}
              ...
              <div className="space-y-2">
                ...
                <NewCustomDatePicker
                  ...
                  maxDate={
                    new Date(
                      moment().add(3, "years").toISOString().split("T")[0]
                    )
                  }
                  isClearable={!!formState?.dueDate}
                />
