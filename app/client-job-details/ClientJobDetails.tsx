...
const GeneralDetails = dynamic(
  () => import("./partials/GeneralDetails"),
  { ssr: false }
);
...
const Milestones = dynamic(
  () => import("./partials/milestones"),
  { ssr: false }
);
const HoursManagement = dynamic(
  () => import("./partials/hours-management"),
  { ssr: false }
);
const Applicants = dynamic(
  () => import("./partials/applicants"),
  { ssr: false }
);
const SubmitEndJobModal = dynamic(
  () => import("./modals/SubmitEndJobModal"),
  { ssr: false }
);
const QuickOptions = dynamic(
  () => import("./quick-options/QuickOptions"),
  { ssr: false }
);
