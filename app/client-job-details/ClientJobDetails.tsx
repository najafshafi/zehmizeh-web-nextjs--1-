                ...
                {jobdetails?.status === "draft" && (
                  <div className="flex items-center justify-between">
                    <CustomButton
                      ...
                      className="px-8 py-4 transition-transform duration-200 hover:scale-105 font-normal text-black rounded-full bg-primary text-[18px] align-left"
                      onClick={onEdit}
                    />
                ...
                {jobdetails.proposal?.approved_budget?.type == "hourly" && (
                  <>
                    ...
                    isFinalHourSubmitted() === false ? (
                      <div className="shadow-[0_4px_74px_rgba(0,0,0,0.04)] bg-white w-[816px] max-w-full mx-auto my-10 p-7 rounded-[1.25rem] text-center">
                        <h3 className="text-[1.2rem]">
                          Freelancer requested to close the project
                        </h3>
                        <div className="mt-4 flex items-center justify-center gap-4">
                          <CustomButton
                            text="Accept - I'll Close"
                            className={`px-8 py-4 transition-transform duration-200 hover:scale-105 font-normal text-black rounded-full bg-primary text-[18px] ${isMobile ? "mt-4 w-100" : ""}`}
