      ...
      <>
        <Helmet>
          ...
          <meta
            ...
            content="Connect with remote, Jewish freelancers on ZehMizeh"
          />
          <meta
            property="og:image"
            content="https://www.zehmizeh.com/images/zehmizeh-logo.png"
          />
          ...
          <meta
            name="twitter:title"
            content="ZehMizeh - The Jewish freelancing platform"
          />
          <meta
        ...
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-W4BL8DL');
          `}
        </Script>
