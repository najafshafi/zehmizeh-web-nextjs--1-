...
//       <div className="flex xl:flex-row flex-col items-center justify-center xl:gap-10 gap-16 h-screen w-full max-w-[1200px] ">
//       <div className="w-full sm:w-3/4 md:w-2/3 lg:w-[70%] xl:w-1/2 px-2 sm:px-4 md:mt-8 lg:mt-20">
//             <div className="relative border-[10px] sm:border-[15px] md:border-[20px] border-gray-100/75 rounded-lg">
//               <svg
//                 width="248"
//                 height="87"
//                 viewBox="0 0 248 87"
...
//                 className="absolute -top-[40px] sm:-top-[60px] md:-top-[85px] left-2 sm:left-4 z-0 scale-75 sm:scale-100"
//               >
//                 <path
//                   fillRule="evenodd"
//                   clipRule="evenodd"
...
//                 fill="none"
//                 xmlns="http://www.w3.org/2000/svg"
//                 className="absolute -bottom-[50px] sm:-bottom-[75px] md:-bottom-[100px] right-2 sm:right-6 scale-75 sm:scale-100"
//               >
//                 <path
...
//                 autoPlay={false}
//                 controls
//                 className="relative z-10 w-full h-auto rounded-lg transition-all duration-300 border-4 border-[#f6f6f5]"
//               >
//                 <source
...
//               </video>
//               {isOverlayVisible && (
//                 <div className="absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center z-20">
//                   <svg
//                     width="48"
//                     height="48"
//                     viewBox="0 0 48 48"
...
//                     width={60}
//                     height={60}
//                     className="absolute cursor-pointer hover:scale-125 transition-transform duration-500 sm:w-20 sm:h-20 md:w-[100px] md:h-[100px]"
//                   />
//                 </div>
//               )}
//             </div>
//           </div>
//         <div className="flex flex-col gap-1 xl:w-[580px]  w-full xl:px-0 px-6">
//           <p className="text-black xl:text-[40px] md:text-[28px] text-[22px] leading-none xl:text-start text-center">
//             Introducing
//           </p>
//           <div className="flex  items-center justify-center">
//             <p className="md:w-full w-[70%] font-bold xl:text-[100px] md:text-[55px] text-[40px] xl:leading-[105px] md:leading-[65px] leading-[45px] xl:text-start text-center tracking-wide">
//               Your{" "}
//               <span className="italic text-primary leading-none">Jewish</span>{" "}
//               Outsourcing Platform
//             </p>
//           </div>
//           <div className="flex items-center justify-center">
//             <p className="md:w-full w-[70%] text-black xl:text-[40px] md:text-[28px] text-[24px] md:leading-[52px] leading-[35px] mt-1 xl:text-start text-center">
