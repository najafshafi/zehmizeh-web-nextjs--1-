...
const AddMilestoneForm = ({ show, toggle, onSubmit, clientUserId, jobPostId, remainingBudget }: Props) => {
    ...
    <StyledModal maxwidth={570} show={show} size="sm" onHide={closeModal} centered>
      <Modal.Body>
        ...
        <FormWrapper onSubmit={onCreate}>
          <div className="fs-24 fw-400">Propose Milestone</div>
          <div className="form-group">
            ...
            <Form.Control
              ...
              onChange={(e) => handleChange('title', e.target.value.replace(REGEX.TITLE, ''))}
          ...
          <div className="form-group">
            <FormLabel className="fs-1rem fw-300">
              ...
              <p className="fs-14 mb-0 fw-300">
                How much would you like to be paid to complete this part of the project?
              </p>
            </FormLabel>
            <Form.Control
          ...
          <div className="form-group">
            ...
            <p className="fs-14 fw-300">
              Describe the work you'll deliver in this milestone. What will be done when you're finished? What content
              will you deliver? Is this a draft, a segment, a complete project?
            </p>
            <TextEditor
          ...
          <div className="form-group">
            ...
            <NewCustomDatePicker
              ...
              onChange={(value) => handleChange('dueDate', adjustTimezone(value))}
