...
//               <div>
//                 {data?.job_title ? (
//                   <div className="headline font-normal fw-400">
//                     <StyledHtmlText
...
//               <div>
//                 {data?.about_me ? (
//                   <div className="about-me font-normal fw-400">
//                     <StyledHtmlText
...
//                 {!data?.skills?.length && (
//                   <>
//                     <p className="text-center font-normal my-3">
...
//             details={
//               <div className="skills list flex items-center flex-wrap">
...
//                     <div className="list flex flex-column gap-3">
//                       {data?.education?.map((eduItem: any) => (
//                         <EducationItem
//                           className="flex p-3 gap-2"
//                           key={eduItem?.education_id}
//                         >
//                           <div className="education-details flex items-center flex-1">
//                             <Image
...
//                               </div>
//                               <div className="education-description font-normal fw-400 capital-first-ltr">
//                                 {convertToTitleCase(eduItem?.school_name)}
//                               </div>
//                               {eduItem?.education_year &&
//                                 eduItem?.education_year !== '-' && (
//                                   <div className="education-description font-normal fw-400">
//                                     {eduItem?.education_year}
//                                   </div>
//                                 )}
//                             </div>
...
//                         <EducationItem
//                           className={cns(
//                             'p-4 flex justify-content-between items-center gap-2',
...
//                             </div>
//                             <div className="education-description font-normal fw-400 mt-2 capital-first-ltr">
...
export const Profile = () => {
  ...
  const searchParams = useSearchParams(); // Use Next.js hook (no destructuring)
  ...
  const onUpdate = () => {
    /*
     * This function will be called after anything is edited/added
     * It closes the modal and refetches the profile
     */
    setEditModalType({ modal: '' });
    refetch();
  };
  ...
  const openCertificate = (link) => {
    // This function opens the certificate link
    if (link) {
  ...
  const getCategoryHandler = () => {
    ...
    categories = categories.map((catName) => {
      const catObj = data?.skills?.filter(
        (skill) => skill.category_name === catName
      )[0];
      return catObj;
    });
        ...
        <Col lg="12">
          ...
          <ProfileDetailSection
            ...
            details={
              <div>
                {data?.job_title ? (
                  <div className="headline text-lg font-normal">
                    <StyledHtmlText
                      htmlString={data?.job_title}
                      needToBeShorten={true}
                      minLines={5}
